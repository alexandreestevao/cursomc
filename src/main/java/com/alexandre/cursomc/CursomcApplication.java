...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Cliente cli1 = new Cliente(null, "Maria da Silva", "maria@gmail.com", "03883483422", TipoCliente.PESSOAFISICA);
		cli1.getTelefones().addAll(Arrays.asList("21232334", "21232223"));
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "88132125", cli1, c1);
		Endereco e2 = new Endereco(null, "Rua Trinta", "33", "Apto 503", "Jardim 2", "88442120", cli1, c2);
		...
		Pedido ped2 = new Pedido(null, sdf.parse("10/10/2018 19:15"), cli1, e2);
